...
let initialState : {userData:null|UserData, token:string|null,isLoading:boolean,error:string,isSuccess:boolean} = {userData:null, token:localStorage.getItem('token'),isLoading:false,error:'',isSuccess:false}
